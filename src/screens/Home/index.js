...
const Home = ({ navigation }) => {
            ...
            const link = await dynamicLinks().buildShortLink(
                {
                    ...
                    social: {
                        title: 'APP DLCONE',
                        imageUrl:
                            'https://ctydlcvn.com/wp-content/uploads/2022/08/af0e6610ccf30ead57e2-removebg-preview.png',
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Input
                pressable
                onPress={() => navigation.navigate('Search', { item: attractions })}
            />
